...
**CI status:** ![CI](http://172.0.0.29:3000/sarman/trcaa-devops_investigation/actions/workflows/test.yml/badge.svg) — all checks green (rustfmt · clippy · 64 Rust tests · tsc · vitest)
