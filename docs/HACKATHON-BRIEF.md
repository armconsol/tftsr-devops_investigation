...
**v1.0.3-v1.0.4**: Query classification (prevents AI from running 20+ commands for simple questions), graceful iteration limit handling, MSI GenAI gateway support  
...
**Install:** Download from [GitHub Releases](https://github.com/msicie/apollo_nxt-trcaa/releases)  
**Quick Start:**
