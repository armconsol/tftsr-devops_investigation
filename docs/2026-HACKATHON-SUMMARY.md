...
3. **TFTSR GenAI Tool Calling Incompatibility**
...
**Root Cause**: TFTSR GenAI gateway not properly translating between provider formats and OpenAI protocol  
...
### ADO Work Item
- **Primary**: [#727547 - POC Using AI LLM for Support](https://dev.azure.com/tftsr/Apollo/_workitems/edit/727547)
