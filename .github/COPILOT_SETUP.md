...
1. Navigate to: `https://github.com/msicie/apollo_nxt-trcaa/settings/security_analysis`
...
2. Navigate to: `https://github.com/msicie/apollo_nxt-trcaa/settings/copilot`
...
```bash
# Via GitHub CLI
gh api repos/msicie/apollo_nxt-trcaa/branches/main/protection/required_status_checks \
  --method PATCH \
  --field strict=true \
...
For questions about GitHub Advanced Security or Copilot features for the MSI-CIE organization, contact:
